...
Route::get('how-to-use', [
    'uses' => 'HomeController@getHowtouse',
    'as' => 'how-to-use'
]);
Route::get('upgrade.business', [
    'uses' => 'HomeController@getUpgradebusiness',
    'as' => 'upgrade.business'
]);
// 
...
Route::get('/test-api', ['uses' => 'TestingController@getTest', 'as' => 'test-api']);
