<?php namespace App\Http\Controllers;
	...
	class AdminBannersController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"External Url","name"=>"external_url"];
			...
			$this->form[] = ['label'=>'External Url','name'=>'external_url','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"External Url","name"=>"external_url","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
